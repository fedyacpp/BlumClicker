...
## Информация от разработчика: по состоянию на 4 июля блум заколлабился с какими-то людьми и из-за этого поменялись вообще все спрайты в drop game, так что завтра я переобучу модель и скину новые веса для нее
